    ...
    <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Joueurs par session</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          <div className="text-2xl font-bold">Mardi 19h</div>
          <p className="text-xs text-muted-foreground">Parc de la Rivière</p>
        </CardContent>
      </Card>
    </div>
  );
